    ...
    return (
        <div className='bg-[#172d41] px-10 '>
            ...
            <div className='flex flex-wrap  Navbar'>
                <div className='flex   items-start  flex-wrap nav-log '>
                    ...
                    <div className='flex   '>
                        ...
                        <div className=' flex flex-col gap-1 my-3 justify-center items-center'>
                            <h1 className='text-4xl font-bold text-slate-500 mx-2'>UVIOM</h1>
                            <span className='mission '> <Typewriter options={{ sutoStart: true, loop: true }}
                                onInit={(typewriter) => {
                                    typewriter.typeString('Your Mission Is Our Vission').pauseFor(2000).deleteAll().start()
                ...
                <div id='navigation' className={`flex gap-6 text-white items-center nav-items ${isOpen && 'open'} `}>
